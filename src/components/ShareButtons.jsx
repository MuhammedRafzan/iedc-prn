...
function ShareButtons({ event }) {
  ...
  const shareText = `Check out ${event.title} at IEDC PRN! ${event.shortDesc}`;
  ...
  return (
    <div className="relative group">
      ...
      {/* Dropdown */}
      <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
        <div className="p-2">
          <a
          ...
          <button
            onClick={handleCopy}
            className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors w-full"
          >
